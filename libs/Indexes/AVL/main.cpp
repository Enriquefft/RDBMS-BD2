...
void addNRandomRecord(AVLIndex<KEY_TYPE>& si, int N, KEY_TYPE min = 0, KEY_TYPE max = 100){
...
int main()
{
    ...
    //Data<attribute_type> item1, item2, item3, item4, item5, item6, item7, item8, item9, item10;
