...
public:
    ...
    SequentialIndexRecord(Data<KEY_TYPE>& _data, physical_pos& _raw_pos, physical_pos& _dup_pos, physical_pos& _current_pos, file_pos& _current_file, physical_pos& _next_post, file_pos& _next_file){
        this->data = _data;
    ...
    friend std::ostream& operator<<(std::ostream& stream, const SequentialIndexRecord<KEY_TYPE>& sir) {
